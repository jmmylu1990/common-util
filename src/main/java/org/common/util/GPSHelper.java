...
public class GPSHelper {
	...
	private static int defaultLevel = 8;

	private GPSHelper() {
	}

	public static String toGeoHash(double lng, double lat) {
		return toGeoHash(lng, lat, defaultLevel);
	}
	...
	public static List<String> getRound8(String geohash) {
		...
		geohashList.add(Base32.encode(mergeLngLat(lowLngBin, lowLatBin)));
		geohashList.add(Base32.encode(mergeLngLat(lowLngBin, midLatBin)));
		geohashList.add(Base32.encode(mergeLngLat(lowLngBin, highLatBin)));

		geohashList.add(Base32.encode(mergeLngLat(midLngBin, lowLatBin)));
		geohashList.add(Base32.encode(mergeLngLat(midLngBin, highLatBin)));

		geohashList.add(Base32.encode(mergeLngLat(highLngBin, lowLatBin)));
		geohashList.add(Base32.encode(mergeLngLat(highLngBin, midLatBin)));
		geohashList.add(Base32.encode(mergeLngLat(highLngBin, highLatBin)));
